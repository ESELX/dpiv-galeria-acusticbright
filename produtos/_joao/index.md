...
hero_align: center
published: true
student_name: João Mourão
student_number: "2024288"
---
...
O brinquedo, quando despido das restantes peças, não apresenta uma forma muito convidativa, sendo essencialmente uma base retangular com ranhuras criadas após a sua montagem. O objeto torna-se então interessante quando a criança utiliza a sua imaginação, assim defendendo os objetivos do grupo.

A nossa principal inspiração com este produto são os famosos conjuntos de cenários para brinquedos. Talvez o exemplo mais comum seria a linha LEGO City que, fora a necessidade de montar cada uma das estruturas, também tem o objetivo de criar um cenário para brincar com os restantes brinquedos da marca.
